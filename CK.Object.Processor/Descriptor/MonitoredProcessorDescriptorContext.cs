...
namespace CK.Object.Processor
{
    ...
    public class MonitoredProcessorDescriptorContext : ProcessorDescriptorContext
    {
        ...
        /// <param name="conditionHookContext">Existing condition hook context to use instead of creating a <see cref="MonitoredPredicateHookContext"/>.</param>
        ...
        public MonitoredProcessorDescriptorContext( IActivityMonitor monitor,
            ...
            : base( conditionHookContext ?? new MonitoredPredicateHookContext( monitor, tags, groupLevel ),
